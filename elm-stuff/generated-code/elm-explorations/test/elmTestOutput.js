...
var author$project$Main$Parts = F4(
	function (face, color, eye, mouth) {
		return {color: color, eye: eye, face: face, mouth: mouth};
	});
var author$project$Main$Warota = {$: 'Warota'};
var author$project$Main$partsEncoder = F2(
		...
		return elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'phrase',
					elm$json$Json$Encode$string(phrase)),
					_Utils_Tuple2(
					'face',
					elm$json$Json$Encode$string(faceFileName)),
					_Utils_Tuple2(
					'color',
					elm$json$Json$Encode$int(color)),
					_Utils_Tuple2(
					'eye',
					elm$json$Json$Encode$int(eye)),
					_Utils_Tuple2(
					'mouth',
					elm$json$Json$Encode$int(mouth))
				]));
	});
		...
		[
			...
			_List_fromArray(
				[
					...
					function (_n0) {
						var parts = A4(author$project$Main$Parts, author$project$Main$Warota, 0, 0, 0);
						var palindrome = 'hanna';
						var expected = elm$json$Json$Encode$string('\n                                {phrase: "わーい", face: "warota", color: 0, eye: 0, mouth: 0}\n                                ');
						return A2(
							elm_explorations$test$Expect$equal,
							expected,
							A2(author$project$Main$partsEncoder, 'わーい', parts));
					}),
					A2(
					elm_explorations$test$Test$test,
...
var author$project$Test$Generated$Main3202079139$main = A2(
	author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/sawanatsumi/workspace/sandbox/elm-warota/tests/Tests.elm']),
		processes: 4,
		report: author$project$Test$Reporter$Reporter$ConsoleReport(author$project$Console$Text$UseColor),
		runs: elm$core$Maybe$Nothing,
		seed: 240675678953065
	},
...
_Platform_export({'Test':{'Generated':{'Main3202079139':{'init':author$project$Test$Generated$Main3202079139$main(elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-47024.sock";
