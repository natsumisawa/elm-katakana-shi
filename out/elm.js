...
var author$project$Main$Model = F2(
	function (showK, katakana) {
		return {katakana: katakana, showK: showK};
	});
...
var author$project$Main$init = _Utils_Tuple2(
	A2(author$project$Main$Model, true, 'ココニカタカナデルヨ'),
	elm$core$Platform$Cmd$none);
var author$project$Main$GenerateK = function (a) {
	return {$: 'GenerateK', a: a};
};
...
var author$project$Main$generateRandomInt = A2(
	elm$random$Random$generate,
	author$project$Main$GenerateK,
	A2(elm$random$Random$int, 0, 465));
var author$project$Main$katakanaList = _List_fromArray(
	['アイスクリーム', 'アイデア', 'アイロン', 'アウト', 'アクセサリー', 'アクセル', 'アクセント', 'アジア', 'アップ', 'アナウンサー', 'アパート', 'アフリカ', 'アプローチ', 'アマチュア', 'アルバイト', 'アルバム', 'アンケート', 'アンコール', 'アンテナ', 'イコール', 'イメージ', 'インターチェンジ', 'インターナショナル', 'インターフォン', 'インタビュー', 'インテリ', 'インフォメーション', 'インフレ', 'ウイルス', 'ウーマン', 'ウール', 'ウエイトレス', 'エアメール', 'エスカレーター', 'エチケット', 'エネルギー', 'エプロン', 'エレガント', 'エレベーター', 'エンジニア', 'エンジン', 'オイル', 'オーケストラ', 'オープン', 'オフィス', 'オリエンテーション', 'オリンピック', 'オルガン', 'オレンジ', 'オンライン', 'ガイド', 'ガイドブック', 'カーテン', 'カード', 'カーブ', 'カーペット', 'ガス', 'ガソリン', 'カット', 'カップ', 'カテゴリー', 'カバー', 'ガム', 'カムバック', 'カメラ', 'カメラマン', 'ガラス', 'カラー', 'カルテ', 'カレー', 'ガレージ', 'カレンダー', 'カロリー', 'カンニング', 'ギター', 'キャッチ', 'キャプテン', 'キャリア', 'ギャング', 'キャンパス', 'キャンプ', 'キロ', 'クイズ', 'クーラー', 'クラシック', 'クラス', 'グラス', 'グラム', 'クリーニング', 'クリーム', 'グループ', 'グレー', 'クレーン', 'ケーキ', 'ゲーム', 'ゲスト', 'コース', 'コーチ', 'コーナー', 'コーヒー', 'コーラス', 'ゴール', 'コピー', 'コマーシャル', 'コミュニケーション', 'コメント', 'コレクション', 'コンクール', 'コンクリート', 'コンサート', 'コンセント', 'コンテスト', 'コントラスト', 'コントロール', 'コンパス', 'コンピューター', 'サイクル', 'サイズ', 'サイレン', 'サイン', 'サークル', 'サービス', 'サラダ', 'サラリーマン', 'サンキュー', 'サンダル', 'サンドイッチ', 'サンプル', 'シーズン', 'ジーンズ', 'システム', 'シナリオ', 'ジャズ', 'シャツ', 'シャッター', 'ジャム', 'ジャーナリスト', 'シャワー', 'ジャンパー', 'ジャンプ', 'ジャンボ', 'ジャンル', 'ジュース', 'ショック', 'ショップ', 'ショー', 'シリーズ', 'スイッチ', 'スカート', 'スカーフ', 'スキー', 'スクール', 'スクリーン', 'スケート', 'スケジュール', 'スーツ', 'スーツケース', 'スープ', 'スタイル', 'スタジオ', 'スター', '
ベルト', 'ペン', 'ペンキ', 'ベンチ', 'ボイコット', 'ポイント', 'ポケット', 'ポジション', 'ポスター', 'ポスト', 'ボタン', 'ポット', 'ホテル', 'ボーイ', 'ホース', 'ボート', 'ボーナス', 'ホーム', 'ホール', 'ボール', 'ボールペン', 'ポンプ', 'マイナス', 'マスク', 'マスコミ', 'マスター', 'マッサージ', 'マッチ', 'マフラー', 'ママ', 'マーク', 'マーケット', 'マラソン', 'マンション', 'ミシン', 'ミスプリント', 'ミュージック', 'ミルク', 'ムード', 'メッセージ', 'メディア', 'メニュー', 'メーカー', 'メーター', 'メール', 'メモ', 'メロディー', 'メンバー', 'モダン', 'モデル', 'モニター', 'モノレール', 'モーター', 'モーテル', 'ヤング', 'ユニーク', 'ユニフォーム', 'ユーモア', 'ヨット', 'ヨーロッパ', 'ライス', 'ライト', 'ライバル', 'ラケット', 'ラジオ', 'ラッシュアワー', 'ラベル', 'ランチ', 'ランニング', 'ランプ', 'リズム', 'リットル', 'リボン', 'リード', 'ルーズ', 'ルール', 'レインコート', 'レギュラー', 'レクリエーション', 'レコード', 'レジ', 'レジャー', 'レストラン', 'レッスン', 'レディー', 'レバー', 'レベル', 'レポート', 'レース', 'レンジ', 'レンズ', 'レントゲン', 'ロケット', 'ロッカー', 'ロビー', 'ロマンチック', 'ロープ', 'ロープウエイ', 'ワイシャツ', 'ワイン', 'ワット', 'ワープロ', 'ワンピース']);
...
var author$project$Main$update = F2(
	function (msg, model) {
		var showK = model.showK;
		var katakana = model.katakana;
		if (msg.$ === 'GenerateK') {
			var _int = msg.a;
			var newShowK = !showK;
			var newKatakana = function () {
				if (newShowK) {
					return katakana;
				} else {
					var _n1 = elm$core$List$head(
						A2(elm$core$List$drop, _int, author$project$Main$katakanaList));
					if (_n1.$ === 'Just') {
						var k = _n1.a;
						return k;
					} else {
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{katakana: newKatakana, showK: newShowK}),
				elm$core$Platform$Cmd$none);
		} else {
			return _Utils_Tuple2(model, author$project$Main$generateRandomInt);
		}
	});
...
var author$project$Main$view = function (model) {
	var katakana = model.katakana;
	var showK = model.showK;
	var fingerClass = showK ? 'buruburu' : '';
	return {
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$src('assets/images/warota.PNG')
							]),
						_List_Nil),
						A2(
						elm$html$Html$img,
						_List_fromArray(
							[
								elm$html$Html$Attributes$id(fingerClass),
								elm$html$Html$Attributes$src('assets/images/finger.PNG'),
								elm$html$Html$Events$onClick(author$project$Main$Random)
							]),
						_List_Nil),
						A2(
						elm$html$Html$img,
						_List_fromArray(
							[
								elm$html$Html$Attributes$src('assets/images/bubble1.PNG')
							]),
						_List_Nil),
						A2(
						elm$html$Html$span,
						...
						_List_fromArray(
							[
								elm$html$Html$text(katakana)
							])),
						A2(
						elm$html$Html$img,
						_List_fromArray(
							[
								elm$html$Html$Attributes$src('assets/images/bubble2.PNG')
							]),
						_List_Nil)
					]))
			]),
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"GenerateK":["Basics.Int"],"Random":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}}}}})}});}(this));